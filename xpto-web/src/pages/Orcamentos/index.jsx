...
import { 
    BudgetContainer, BudgetDescContainer, 
    BudgetPriceContainer, BudgetSection, 
    BudgetSetContainer, BudgetTipContainer, 
    BudgetTitleContainer, Content, 
    InputContainer, QuestionContainer 
} from "./styles";
